                    ...
                    {Req.Cookies.length !== 0 ?
                        <div className="md:w-1/2 w-full flex flex-row gap-3 items-center">
                            ...
                            <div className="flex flex-col">
                                <strong className='text-2xl'>Bookmark</strong>
            ...
            {Req.Cookies.length !== 0 &&
                <div className="container mx-auto mb-16 p-3">
                    <div className="flex gap-3 mb-5">
                        <strong className="text-2xl">{Req.Cookies.length}</strong>
                        <div className="flex flex-col">
                    ...
                    <div className="grid md:grid-cols-6 grid-cols-3 gap-2 mb-10">
                        {Req.Cookies?.slice(0, Req.HentaiPage).map((doc, index) => 
                            <Link href={`/hentai/${doc.Slug}`} key={index} className="btn btn-ghost normal-case h-auto p-0" aria-label={doc.Title}>
                                <img src={doc.Image ? `https://cdn-cloudapi.vercel.app/img/hentai/${doc.Image}` : '/Logo.svg'} className="rounded" width="240" height="320" lazy='loading' alt={doc.Title} />
                    ...
                    {Req.Cookies.length >= Req.HentaiPage &&
                        <center>
